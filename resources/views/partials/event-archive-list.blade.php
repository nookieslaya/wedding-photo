<section class="events-list-module relative bg-[#d8d8da] pb-8 pt-24 text-black md:pb-12 md:pt-32" data-events-module>
    ...
    @if (have_posts())
      <div class="space-y-3 md:space-y-4">
        @while (have_posts())
          ...
          <article class="overflow-hidden rounded-[4px] bg-[#ececee] p-2 md:h-[470px] md:max-h-[470px] md:p-0" data-events-item>
            <a href="{{ $eventLink }}"
