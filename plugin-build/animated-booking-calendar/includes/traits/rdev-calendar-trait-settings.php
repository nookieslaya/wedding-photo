...
trait Rdev_Calendar_Settings_Trait {
    ...
    public static function render_settings_metabox(\WP_Post $post): void {
        ...
        <table class="form-table abc-settings-table" role="presentation">
            ...
            <tr><th><label for="abc_booking_client_rejected_email_body">Client email body (rejected)</label></th><td><textarea class="large-text" rows="6" id="abc_booking_client_rejected_email_body" name="abc_settings[booking_client_rejected_email_body]"><?php echo $textarea($s['booking_client_rejected_email_body']); ?></textarea><p class="description">Placeholders: {full_name}, {date}, {option}, {status}, {site_name}</p></td></tr>
